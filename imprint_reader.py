...
if __name__ == "__main__":
    ...
    try:
        ...
        reader._min_val = engine.autonomic_kernel["calibrated_min"]
        reader._max_val = engine.autonomic_kernel["calibrated_max"]
        reader.current_arousal = engine.autonomic_kernel["base_arousal"]    
        ...
        while True:
            ...
            stream_autonomic_passage(
                ...
                num_sentences=8, 
                tokens_per_sent=50, 
                seed_text=input("Query:")
            )
    except FileNotFoundError:
        print("[!] Could not find 'v18rp_engine.pkl'. Please train the engine first.")
     # Inherit the embedded user mind kernel into the live reader
