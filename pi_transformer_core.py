...
class IsomorphismPipeline(nn.Module):
    ...
    def step(self, ctx: deque, prompt_words: List[str], draw: float):
        ...
        all_layers = (L0, L1, L2, L3, *(zl[1] for zl in zone_layers), L10, L11, L12, L13)
...
from granule_geometry import (
    CandidateMatrix, membership_matrix, granule_centroids,
    gaussian_granule_masks, granule_areas, word_granule_area,
    zone_dist_from_granules,
)
from zone_layers import (
    L4_ZoneFreq, L5_ZoneAlpha, L6_ZoneBigram,
    L7_ZoneTrigram, L8_ZoneCharTrig, L9_ZoneLatent,
    L14_LockedStateIndex,
)
